...
from open3dis.dataset.scannetpp import INSTANCE_CAT_SCANNET_PP
...
##############################################
"""
We generate class-agnostic 2D masks based on {DATASET} class name
and CLIP features using 2D foundation models -> Speed
"""
...
if __name__ == "__main__":
    ...
    # Foundation model loader (lazy import)
    if cfg.segmenter2d.model == "Grounded-SAM":
        ...
        raise ValueError(f"Unknown 2D segmenter: {cfg.segmenter2d.model}")
